const QUESTIONS = [
  ...
  },
  {
    ...
    "observation": "A sample is subjected to the Baeyer test to identify a specific hydrocarbon.",
    "question": "In the Baeyer test, what specific observations indicate a positive result for an alkene?",
    "answers": [
      ["Disappearance of purple color and formation of a brown suspension", true, "#8a2be2"],
    ...
    "explanation": "A positive Baeyer test involves the purple permanganate color vanishing and being replaced by a brown MnO2 suspension."
  },
  {
    "room": "Room 3: Lucas Reagent",
    "observation": "Various alcohols are reacted with the Lucas reagent (HCl/ZnCl2) at room temperature.",
    "question": "Which type of alcohol reacts almost immediately with the Lucas reagent?",
    "answers": [
  ...
  {
    "room": "Room 4: Carbonyl Identification",
    "observation": "An unknown sample is tested using the 2,4-DNP reagent.",
    "question": "The 2,4-DNP test is used to identify which of the following pairs of functional groups?",
    "answers": [
  ...
  {
    "room": "Room 5: Halide Acceleration",
    "observation": "In a test for halides using NaI in acetone, no precipitate forms after 5 minutes at room temperature.",
    "question": "What should be done if no precipitate forms?",
    "answers": [
      ["Add Tollen's reagent", false, "#c0c0c0"],
      ["Place the test tube in a 50°C water bath", true, "#00d4ff"],
  ...
  {
    "room": "Room 6: Tollen's vs 2,4-DNP",
    "observation": "A sample gives a positive 2,4-DNP test but a negative Tollen's test.",
    "question": "If a sample gives a positive 2,4-DNP test but a negative Tollen's test, what can you conclude?",
    "answers": [
